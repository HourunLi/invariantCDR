...
# train
parser.add_argument('--epoch', type=int, default=70, help='number of epoches')
...
parser.add_argument('--lambda_constra', type=float, default=0.3, help='the parameter of constractive loss function')
parser.add_argument('--lambda_critic', type=float, default=0.3, help='the parameter of critic loss function')
