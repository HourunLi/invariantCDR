...
parser.add_argument('--conv_layers', type=int, default=3, help="number of graph convolutional layers")
...
parser.add_argument('--num_negative', type=int, default=20, help='num of negative samples during training')
...
parser.add_argument('--transfer_epoch', type=int, default=60, help='transfer learning after this epoch.')
...
parser.add_argument('--lr_transfer', type=float, default=5e-4, help='learning rate')
...
parser.add_argument('--leakey', type=float, default=0.01)
parser.add_argument('--lambda_constra', type=float, default=0.15, help='the parameter of constractive loss function')
parser.add_argument('--lambda_critic', type=float, default=0.35, help='the parameter of critic loss function')
parser.add_argument('--lambda_ease', type=float, default=50, help='the parameter of EASE')
...
parser.add_argument('--tau', type=float, default=0.4, help="temperature parameter for scaling the similarity scores")
