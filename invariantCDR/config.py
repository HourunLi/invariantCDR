...
parser.add_argument('--leakey', type=float, default=0.05)
parser.add_argument('--alpha', type=float, default=0.5, help='the weight of I in similarity')
parser.add_argument('--dropout', type=float, default=0.4, help='random drop out rate')
parser.add_argument('--lambda_critic', type=float, default=0.1, help='the parameter of critic loss function')
parser.add_argument('--beta_inter', type=float, default=0.2)
